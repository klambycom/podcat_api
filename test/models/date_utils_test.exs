defmodule PodcatApi.DateUtilsTest do
  use PodcatApi.ModelCase
  doctest PodcatApi.DateUtils
  doctest PodcatApi.DateUtils.RFC2822
  ...
  test "parse RFC822 with time zone with minutes (+hhmm)" do
    ...
    assert RFC2822.parse("19 May 2002 15:21:36 +0130") == date
  end

  test "parse RFC822 with single digit day" do
    date = %{@valid_date | day: 1}
    assert RFC2822.parse("1 May 2002 15:21:36 GMT") == date
  end
